...
Output
For each test case, output one line containing Case #x: y, where x is the test case number (starting from 1) and y is the length of the longest contiguous 
arithmetic subarray.
...
In Sample Case #3, the longest contiguous arithmetic subarray is either [5, 5, 5] (a subarray from the fourth integer to the sixth integer) 
...
public class LongestArithmetic{
    public static void main(String[] args){
        ...
        while(t-->0){
            ...
            System.out.println("Case #" + j + ": " + maxContinuous);
        }
    }
}
